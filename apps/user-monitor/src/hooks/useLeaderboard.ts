...
const PLACEHOLDER: LeaderboardResponse = {
  entries: [
    ...
    { rank: 11, firstName: 'Filip',   lastName: 'Knežević',   bestLapMs: 87890, bestLapFormatted: '1:27.890', completedAt: '2026-05-13T10:50:00Z' },
    { rank: 12, firstName: 'Ivana',   lastName: 'Vuković',    bestLapMs: 88234, bestLapFormatted: '1:28.234', completedAt: '2026-05-13T10:55:00Z' },
    { rank: 13, firstName: 'Nikola',  lastName: 'Rajković',   bestLapMs: 88678, bestLapFormatted: '1:28.678', completedAt: '2026-05-13T11:00:00Z' },
  ],
...
export function useLeaderboard(signalRConnected = false) {
