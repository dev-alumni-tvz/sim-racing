...
const INITIAL_PLAYED: PlayedEntry[] = [
  { playOrder: 1, attendeeId: 'lb1', sessionId: 's-lb1', ticketNumber: '001', name: 'Ivan Horvat',  firstName: 'Ivan',  lastName: 'Horvat', rank: 1, gap: null,     lapTime: '1:23.456', bestLapMs: 83456 },
  { playOrder: 2, attendeeId: 'lb2', sessionId: 's-lb2', ticketNumber: '002', name: 'Marko Perić', firstName: 'Marko', lastName: 'Perić',  rank: 2, gap: '+0.633', lapTime: '1:24.089', bestLapMs: 84089 },
]

const DRIVER_RESULTS: PlayedEntry[] = [
  { playOrder: 3, attendeeId: 'a1', sessionId: 's-a1', ticketNumber: '007', name: 'Davor Martinović', firstName: 'Davor',  lastName: 'Martinović', rank: 10, gap: '+4.000', lapTime: '1:27.456', bestLapMs: 87456 },
  { playOrder: 4, attendeeId: 'a2', sessionId: 's-a2', ticketNumber: '008', name: 'Luka Babić',       firstName: 'Luka',   lastName: 'Babić',      rank: 4,  gap: '+1.778', lapTime: '1:25.234', bestLapMs: 85234 },
  { playOrder: 5, attendeeId: 'a3', sessionId: 's-a3', ticketNumber: '009', name: 'Filip Knežević',   firstName: 'Filip',  lastName: 'Knežević',   rank: 7,  gap: '+2.889', lapTime: '1:26.345', bestLapMs: 86345 },
  { playOrder: 6, attendeeId: 'a4', sessionId: 's-a4', ticketNumber: '010', name: 'Ivana Vuković',    firstName: 'Ivana',  lastName: 'Vuković',    rank: 5,  gap: '+2.222', lapTime: '1:25.678', bestLapMs: 85678 },
  { playOrder: 7, attendeeId: 'a5', sessionId: 's-a5', ticketNumber: '011', name: 'Nikola Rajković',  firstName: 'Nikola', lastName: 'Rajković',   rank: 3,  gap: '+1.435', lapTime: '1:24.891', bestLapMs: 84891 },
  { playOrder: 8, attendeeId: 'a6', sessionId: 's-a6', ticketNumber: '012', name: 'Tea Živković',     firstName: 'Tea',    lastName: 'Živković',   rank: 6,  gap: '+2.556', lapTime: '1:26.012', bestLapMs: 86012 },
]
